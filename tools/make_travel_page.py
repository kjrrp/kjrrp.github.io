...
first_item = '''                <h2 id="title" class="fr">%s</h2>
                ...
                <!-- 1st -->
                <div class="center">
                    <a href="http://kjrrp.ddns.net/pics/travel/%s" class="html5lightbox"
                        data-group="mygroup" data-transition="slide" data-fullscreenmode="true" data-autoplay="false"
                        data-thumbnail="http://kjrrp.ddns.net/pics/travel/%s" title=""
                    ...
                    <!-- Rest -->
'''
image = '''                    <a href="http://kjrrp.ddns.net/pics/travel/%s" class="html5lightbox"
                        data-group="mygroup" style="display:none" data-transition="slide" data-fullscreenmode="true"
                        data-autoplay="false" data-thumbnail="http://kjrrp.ddns.net/pics/travel/%s"
                        title=""></a>
'''
video = '''                    <a href="http://kjrrp.ddns.net/pics/travel/%s" class="html5lightbox"
                        data-group="mygroup" style="display:none" data-transition="slide" data-fullscreenmode="true"
                        data-autoplay="false" data-thumbnail="http://kjrrp.ddns.net/pics/travel/%s"
                        data-webm="http://kjrrp.ddns.net/pics/travel/%s" title=""></a>
'''
