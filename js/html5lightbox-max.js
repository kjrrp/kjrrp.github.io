	...
	(function ($) {
		$.fn.html5lightbox = function (options) {
			...
			inst.options = $.extend({
				...
				fadespeed: 0,
				jsfolder: jsFolder,
				skinsfoldername: "../img/website/html5boxplayer",
			...
			if (inst.options.initsocial) $("head").append('<link rel="stylesheet" href="' + inst.options.jsfolder + '../stylesheets/fontello.css" type="text/css" />');
			inst.showing = false;
			...
			inst.showTitle =
				function (t, description) {
					...
					if (inst.options.inGroup) {
						...
						if (false) text = "<div class='html5-playpause' style='display:inline-block;cursor:pointer;vertical-align:middle;width:" + inst.options.playimagesize +
